<div class="row justify-content-center">
    <div class="col-xl-8 col-lg-9 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
            	<?php echo form_open_multipart("index.php?admin/documentary_create"); ?>
					...
					<div class="row justify-content-center">
						<div class="col-12">
							...
							<div class="form-group">
								...
								<a href="<?php echo base_url();?>index.php?admin/documentary_list" class="btn btn-secondary">Go back</a>
							</div>
						</div>
					</div>
				<!-- </form> -->
