...
<?php
	$reality_detail = $this->db->get_where('reality_show',array('reality_id'=>$reality_id))->row();
?>
<form method="post" action="<?php echo base_url();?>index.php?admin/reality_edit/<?php echo $reality_id;?>" enctype="multipart/form-data">
	<div class="row">
	    <div class="col-6">
	        <div class="card">
	            <div class="card-body">
					<div class="form-group mb-3">
	                    ...
	                    <input type="text" class="form-control" id = "simpleinput1" name="title" value="<?php echo $reality_detail->title;?>">
	                </div>

	                <div class="form-group mb-3">
						<label for="description_long">Long description</label>
						<textarea class="form-control" id="description_long" name="description_long" rows="6"><?php echo $reality_detail->description_short;?></textarea>
					</div>

					<div class="form-group mb-3">
						<label for="description_short">Short description</label>
						<textarea class="form-control" id="description_short" name="description_short" rows="6"><?php echo $reality_detail->description_long;?></textarea>
					</div>
					...
					<div class="form-group mb-3">
						...
						<select class="form-control select2" id="genre_id" name="genre_id">
							...
							<option
								<?php if ( $reality_detail->genre_id == $row2['genre_id']) echo 'selected';?>
					...
					<div class="form-group mb-3">
						...
						<select class="form-control select2" id="year" name="year">
							...
							<option
								<?php if ( $reality_detail->year == $i) echo 'selected';?>
								value="<?php echo $i;?>">
								<?php echo $i;?>
							</option>
							<?php endfor;?>
					...
					<div class="form-group mb-3">
						...
						<select class="form-control select2" id="rating" name="rating">
							<?php for ($i = 0; $i <= 5 ; $i++):?>
							<option
								<?php if ( $reality_detail->rating == $i) echo 'selected';?>
								value="<?php echo $i;?>">
								<?php echo $i;?>
							</option>
							<?php endfor;?>
					...
					<div class="form-group mb-3">
						...
						<select class="form-control select2" id="featured" name="featured">
							<option value="0" <?php if ( $reality_detail->featured == 0) echo 'selected';?>>No</option>
							<option value="1" <?php if ( $reality_detail->featured == 1) echo 'selected';?>>Yes</option>
						</select>
					</div>
	            </div>
	        </div>
						...
						<div class="card-body">
							<div class="form-group">
								...
								<video class="video-js vjs-default-skin" width="440" height="240"
				                 poster="<?php echo "<img src=".base_url('assets/global/reality_thumb/'.$reality_detail->thumbnail)."'  > " ?>"
					                data-setup='{"controls" : true, "autoplay" : false, "preload" : "auto"}'>
					            
					            <source type='video/mp4' src="<?php echo base_url('assets/global/reality_video/'.$reality_detail->file_video); ?>"  />
